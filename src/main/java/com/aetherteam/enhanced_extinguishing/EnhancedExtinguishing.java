...
//    }
    ...
    private void setupRecipeOverridePack(AddPackFindersEvent event) {
        if (event.getPackType() == PackType.SERVER_DATA) {
            ...
            PathPackResources pack = new PathPackResources(ModList.get().getModFileById(EnhancedExtinguishing.MODID).getFile().getFileName() + ":" + resourcePath, resourcePath);
            PackMetadataSection metadata = new PackMetadataSection(Component.literal(""), PackType.SERVER_DATA.getVersion(SharedConstants.getCurrentVersion()));
