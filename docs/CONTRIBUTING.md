...
To open a pull request, go to the [pull requests page](https://github.com/Gilded-Games/Enhanced-Extinguishing/pulls), and an indicator should show up on the page to create a PR from a recent commit to a fork.
